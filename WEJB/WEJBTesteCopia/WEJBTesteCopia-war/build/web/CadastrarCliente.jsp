...
<body>
    <table  width=1500 height=10 cellpadding=1 cellspacing=1 class="estilotabela"align="center">
        <tr><td><H1 align="center">Cadastro Cliente</H1> </td></tr>
    </table>
    ...
    <ul class="nav">
        <table border="25" align="center">
            <form action="ValidarCadastroCliente" method="post" align="center">
                ...
                <tr><td> RG          :     <input type="text" name="RG_Cliente"  maxlength="12" size="12" value=<%=rg%>> </td></tr>
               <tr><td> Telefone     :     <input type="text" name="Telefone_Cliente" maxlength="12" size="12" value=<%=telefone%>> </td></tr>
                <tr><td> Sexo (M/F)   :    <input type="text" name="Sexo_Cliente" size="1" value=<%=sexo%> ></td></tr>
                <tr><td> Estado Civil :    <input type="text" name="EstadoCivil_Cliente" size="20" value=<%=estadocivil%> >  </td></tr>                                                  
                <tr><td> Email        :     <input type="text" name="Email_Cliente"  size="40" maxlength="40"  value=<%=email%>> </td></tr>
                
                
                <tr><td> Endereço     :     <input type="text" name="Endereco_Cliente"ID="7"  size="50"  value=<%=endereco%>> </td></tr>
                ...
                <tr><td> <input type="submit" name="Cadastrar" value="Cadastrar" />

            </form>
            <form action="CadastrarCliente.jsp" method="post"align="center" >
                <%
                    session.invalidate();
                %>
    ...
    <ul class="nav">
        <table border="3" align="center">
            ...
            <tr>
            <tr><td><li> 
                <a href="index.jsp">Voltar</a></li></td></tr>
        </table>
    </table>
</ul>
